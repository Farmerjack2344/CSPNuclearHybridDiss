...
turbine_list = [HP_turbine, LP_turbine_1, LP_turbine_2]
pump_list = [condensate_pump, booster_pump, feed_pump]
...
P_turbine_design, P_pumps_design = solve_power_block(Q_to_steam_design, steam_side_sg,steam_side_reheater,SteamCycle,turbine_list,pump_list)
